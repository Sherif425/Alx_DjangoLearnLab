...
SECRET_KEY = 'django-insecure-+$c@r6y(12$wq_#vdp5u5a3^-+@1w1z!10be6uy^co_i1mm&pf'
...
REST_FRAMEWORK = {
    # Default filter backends so views don't need to set them if you want global behavior
